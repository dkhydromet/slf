# Install script for directory: /home/jchoi/Documents/Work/nasa/trunk/applications
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xexex" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/jchoi/Documents/Work/nasa/trunk/bin/meteoio_timeseries")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/meteoio_timeseries" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/meteoio_timeseries")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/meteoio_timeseries"
         OLD_RPATH "/home/jchoi/Documents/Work/nasa/trunk/lib:"
