# Install script for directory: /home/jchoi/Documents/Work/nasa/snowpack/trunk/applications/snowpack
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xexex" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/jchoi/Documents/Work/nasa/snowpack/trunk/bin/snowpack")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/snowpack" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/snowpack")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/snowpack"
         OLD_RPATH "/home/jchoi/Documents/Work/nasa/snowpack/trunk/lib:/usr/local/lib:"
